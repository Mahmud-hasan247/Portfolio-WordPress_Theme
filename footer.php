<footer>
      ...
      <div class="footer-svg">
        <svg
          ...
          y="0px"
          viewBox="0 0 1920 80"
          style="enable-background: new 0 0 1920 80"
          xml:space="preserve"
        >
          <path
            class="st0"
            d="M0,27.2c589.2,129.4,1044-69,1920,31v-60H3.2L0,27.2z"
          />
        </svg>
      </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="footer-">
                  <p>
                    Copyright &copy; 2020-2021 Niwax. All rights reserved.
                    Template By
                    <a
    ...
    <script data-cfasync="false" src="<?php echo get_template_directory_uri(); ?>/js/email-decode.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/modernizr-3.5.0.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/jquery.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/plugin.min.js"></script>
